...
function data_processing(){
	...
	if [[ ${determine_type} = "0" ]]; then
		...
		clear
		echo -e "安装V2Ray主程序中..."
		bash <(curl https://raw.githubusercontent.com/hahaluan/http/master/go.sh)
		if [[ $? -eq 0 ]];then
			clear
		...
		if [[ ${determine_type} = "1" ]]; then
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/socks5.json"
			if [[ $? -eq 0 ]];then
				clear
			...
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/tcp-http.json"
			if [[ $? -eq 0 ]];then
				clear
			...
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/tcp-tls.json"
			if [[ $? -eq 0 ]];then
				clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
			...
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/mkcp-utp.json"
			if [[ $? -eq 0 ]];then
				clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
			...
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/mkcp-dtls.json"
			if [[ $? -eq 0 ]];then
				clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
			...
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/mkcp-srtp-dynport.json"
			if [[ $? -eq 0 ]];then
				clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
			...
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/h2-path.json"
			if [[ $? -eq 0 ]];then
				clear
				echo -e "${ok_font}V2Ray 配置文件下载成功。"
			else
			...
			wget -O "/etc/v2ray/config.json" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/websocket-tls-website-path.json"
			wget -O "/usr/local/caddy/Caddyfile" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/configs/websocket-tls-website-path.Caddyfile"
			clear
			install_port="80"
			check_port
			clear
			...
			if [[ ${install_domain} = "" ]]; then
				...
				wget -O "/etc/v2ray/pages/v2ray-page.zip" "https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/pages/v2ray-page.zip"
				if [[ $? -eq 0 ]];then
					clear
...
function upgrade_shell_script(){
	...
	curl -O https://raw.githubusercontent.com/hahaluan/v2ray-onekey/master/v2ray-go.sh
	if [[ $? -eq 0 ]];then
		clear
